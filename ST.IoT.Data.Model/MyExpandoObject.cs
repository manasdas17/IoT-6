...
namespace ST.IoT.Data.Model
{
    internal static class Error
    {
        ...
        internal static Exception AmbiguousMatchInExpandoObject(string name)
        {
            throw new NotImplementedException();
        }

        internal static Exception SameKeyExistsInExpando(string name)
        {
            throw new NotImplementedException();
        }
        ...
        internal static Exception KeyDoesNotExistInExpando(string key)
        {
            throw new NotImplementedException();
        }
    }
    ...
    public class ExpandoObject : IDynamicMetaObjectProvider, IDictionary<string, object>, INotifyPropertyChanged
    {
        ...
        private class MetaExpando : DynamicMetaObject
        {
            ...
            private BindingRestrictions GetRestrictions()
            {
                ...
                return BindingRestrictions.GetTypeRestriction(Expression, this.GetType());
            }
